/* Quarter-Long Virtual World Project - Functions Class
    ...
    */
    ...
    private static boolean processLine(String line, WorldModel world, ImageStore imageStore)
    {
        ...
        if (properties.length > 0) 
        {
            ...
            {
                case BGND_KEY:     return parseBackground(properties, world, imageStore);
                case MINER_KEY:    return parseMiner(properties, world, imageStore);
                case OBSTACLE_KEY: return parseObstacle(properties, world, imageStore);
                case ORE_KEY:      return parseOre(properties, world, imageStore);
                case SMITH_KEY:    return parseSmith(properties, world, imageStore);
                case VEIN_KEY:     return parseVein(properties, world, imageStore);
            }
        }
    ...
    private static boolean parseBackground(String[] properties, WorldModel world, ImageStore imageStore)
    {
        ...
        {
            Point pt = new Point(
                Integer.parseInt(properties[BGND_COL]),
    ...
    private static boolean parseMiner(String[] properties, WorldModel world, ImageStore imageStore)
    {
        ...
        {
            Point pt = new Point(
                Integer.parseInt(properties[MINER_COL]),
                Integer.parseInt(properties[MINER_ROW]));
            IEntity entity = Factory.createEntityMinerNotFull(
                properties[MINER_ID],
    ...
    private static boolean parseObstacle(String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == OBSTACLE_NUM_PROPERTIES) 
        {
            ...
            IEntity entity = Factory.createEntityObstacle(
                properties[OBSTACLE_ID], 
                pt,
    ...
    private static boolean parseOre(String[] properties, WorldModel world, ImageStore imageStore)
    {
        ...
        {
            Point pt = new Point(
                Integer.parseInt(properties[ORE_COL]),
                Integer.parseInt(properties[ORE_ROW]));
            IEntity entity = Factory.createEntityOre(
                properties[ORE_ID], 
                pt, 
    ...
    private static boolean parseSmith(String[] properties, WorldModel world, ImageStore imageStore)
    {
        ...
        {
            Point pt = new Point(
                Integer.parseInt(properties[SMITH_COL]),
                Integer.parseInt(properties[SMITH_ROW]));
            IEntity entity = Factory.createEntityBlacksmith(
                properties[SMITH_ID], 
                pt,
